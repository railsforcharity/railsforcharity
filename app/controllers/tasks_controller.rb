class TasksController < ApplicationController
  before_filter :find_project, :only => [:new, :create, :update, :show, :edit, :update]
  ...
  def create
    ...
    respond_to do |format|
      if @task.save
        ...
        format.html { redirect_to  project_task_path(@project, @task), notice: t('controllers.tasks.create.success') }
        format.json { render json:  project_task_path(@project, @task), status: :created, location: @task }
      else
