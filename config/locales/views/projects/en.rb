{
  en: {
    views: {
      projects: {
        help: {
          name: "The name of the project should be unique across all Rails for Charity projects. The project's github repository will be created under the railsforcharity account at github.com/railsforcharity",
