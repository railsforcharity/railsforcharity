{
  en: {
    views: {
      projects: {
        help: {
          name_and_picture: "The name of the project should be unique across all Rails for Charity projects. Choose a picture to be displayed as a project thumbnail.",
